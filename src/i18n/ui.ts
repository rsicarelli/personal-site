...
export const ui = {
  en: {
    ...
    'home.heading': 'Rodrigo Sicarelli',
    'home.intro':
      'This is where I gather what I learn and love to share — Kotlin Multiplatform, mobile architecture and developer experience, in English and Portuguese.',
    'home.credential.role': 'Staff Engineer @ Stone',
    'home.credential.speaker': 'KotlinConf 2025 speaker',
    'home.credential.oss': 'OSS maintainer',
    'home.highlights': 'Highlights',
    'home.paths': 'Learning paths',
    'home.allPaths': 'All learning paths',
    'home.projectTile': 'OSS project',
    'home.stats.articles': 'articles',
    'home.stats.series': 'learning paths',
    'home.stats.talks': 'talks',
    'home.stats.projects': 'OSS projects',
    'home.contactTeaser': 'Technical questions, speaking invites or partnerships? Let’s talk.',
    ...
    'footer.group.personal': 'Personal',
    'footer.group.subscribe': 'Subscribe',
    ...
    'talks.photosLink': 'Photos from talks →',
    ...
    'search.label': 'Search',
    'search.title': 'Search',
    'search.placeholder': 'Search posts, projects, talks…',
    'search.inputLabel': 'Search query',
    'search.button': 'Search',
    'search.filter.label': 'Filter by type',
    'search.filter.all': 'All',
    'search.type.blog': 'Posts',
    'search.type.project': 'Projects',
    'search.type.talk': 'Talks',
    'search.type.material': 'Materials',
    'search.results.count': '{n} results for “{q}”',
    'search.results.count.one': '{n} result for “{q}”',
    'search.zero.title': 'What are you looking for?',
    'search.zero.browse': 'Or browse:',
    'search.popularTopics': 'Popular topics',
    'search.recent': 'Recent posts',
    'search.empty.title': 'No results for “{q}”',
    'search.empty.hint': 'Try a different term, or browse below.',
    'search.error': 'Search is temporarily unavailable.',
    'search.error.hint': 'Try browsing the site instead.',
    'search.loading': 'Searching…',
    'search.showingFor': 'Showing results for “{q}”',
    'talks.kind.talk': 'Talk',
    'talks.kind.workshop': 'Workshop',
    'talks.kind.panel': 'Panel',
    'talks.kind.conference': 'Conference',
  },
  'pt-br': {
    'site.title': 'rsicarelli.com',
    'site.description':
    ...
    'home.heading': 'Rodrigo Sicarelli',
    'home.intro':
      'Aqui eu reúno o que aprendo e adoro compartilhar — Kotlin Multiplatform, arquitetura mobile e developer experience, em inglês e português.',
    'home.credential.role': 'Staff Engineer na Stone',
    'home.credential.speaker': 'Palestrante na KotlinConf 2025',
    'home.credential.oss': 'Mantenedor de OSS',
    'home.highlights': 'Destaques',
    'home.paths': 'Trilhas de aprendizado',
    'home.allPaths': 'Todas as trilhas',
    'home.projectTile': 'Projeto OSS',
    'home.stats.articles': 'artigos',
    'home.stats.series': 'trilhas',
    'home.stats.talks': 'palestras',
    'home.stats.projects': 'projetos OSS',
    'home.contactTeaser':
      'Dúvidas técnicas, convites para palestras ou parcerias? Vamos conversar.',
    'home.contactCta': 'Entre em contato',
    'nav.home': 'Início',
    'nav.blog': 'Blog',
    ...
    'footer.rss': 'RSS',
    'footer.newsletter': 'Newsletter',
    'footer.group.explore': 'Explorar',
    'footer.group.personal': 'Pessoal',
    'footer.group.subscribe': 'Assinar',
    ...
    'talks.photosLink': 'Fotos das palestras →',
    'cv.title': 'Currículo',
    ...
    'search.label': 'Buscar',
    'search.title': 'Buscar',
    'search.placeholder': 'Buscar posts, projetos, palestras…',
    'search.inputLabel': 'Termo de busca',
    'search.button': 'Buscar',
    'search.filter.label': 'Filtrar por tipo',
    'search.filter.all': 'Tudo',
    'search.type.blog': 'Posts',
    'search.type.project': 'Projetos',
    'search.type.talk': 'Palestras',
    'search.type.material': 'Materiais',
    'search.results.count': '{n} resultados para “{q}”',
    'search.results.count.one': '{n} resultado para “{q}”',
    'search.zero.title': 'O que você procura?',
    'search.zero.browse': 'Ou navegue por:',
    'search.popularTopics': 'Temas populares',
    'search.recent': 'Posts recentes',
    'search.empty.title': 'Nenhum resultado para “{q}”',
    'search.empty.hint': 'Tente outro termo, ou navegue abaixo.',
    'search.error': 'A busca está temporariamente indisponível.',
    'search.error.hint': 'Tente navegar pelo site.',
    'search.loading': 'Buscando…',
    'search.showingFor': 'Mostrando resultados para “{q}”',
    'talks.kind.talk': 'Palestra',
    'talks.kind.workshop': 'Workshop',
    'talks.kind.panel': 'Painel',
    'talks.kind.conference': 'Conferência',
  },
