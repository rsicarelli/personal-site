...
export const ui = {
  en: {
    ...
    'home.intro':
      'I build the platforms other engineers ship on — and write down everything I learn about Kotlin Multiplatform, mobile architecture and developer experience along the way.',
    'home.eyebrow': 'Mobile platform engineering, written down',
    'home.cta.start': 'Start with KMP 101',
  ...
  'pt-br': {
    ...
    'home.heading': 'Rodrigo Sicarelli',
    'home.intro':
      'Construo as plataformas em que outros engenheiros entregam — e escrevo tudo que aprendo sobre Kotlin Multiplatform, arquitetura mobile e developer experience pelo caminho.',
    'home.eyebrow': 'Engenharia de plataforma mobile, por escrito',
    'home.cta.start': 'Comece pelo KMP 101',
